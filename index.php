    ...
    <section class="w-[80%] bg-black mx-auto overflow-x-scroll mt-[3em] mb-[3em]">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <td><button type='button' class='text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 editButton' data-id=" . $row['City_ID'] . " data-name = " . $row['name'] . " data-population=" . $row['population'] . " data-languege = " . $row['language'] . ">edit</button></td>
