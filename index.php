...
<body>
            ...
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        ...
                        <li>
                            <a href="./pages/addCIty.php" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">AddCity</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <section class="w-[80%] bg-black mx-auto overflow-x-scroll mt-[3em] mb-[3em]">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <td class='px-6 py-4 whitespace-nowrap'>" . $row['language'] . "</td>
                <td class='px-6 py-4 whitespace-nowrap'>" . $row['name'] . "</td>
                <td class='px-6 py-4 whitespace-nowrap'>" . $row['type'] . "</td>
                <td><button type='button' class='text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 editButton' data-id=" . $row['Country_ID'] . " data-name = " . $row['Name'] . " data-population=" . $row['population'] . " data-languege = " . $row['language'] . ">edit</button></td>
                <td><button type='button' class='text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800'>delete</button></td>
            </tr>";
                    }
                }
                ?>
